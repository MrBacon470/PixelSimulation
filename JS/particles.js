...
const particleTypes = [
    ...
    {/*HYGN*/
    name: 'Hydrogen Gas',
    desc: 'Combine with OXYG to get WATR',
    abbr: 'HYGN',
    color: '#5070FF',
    flammable: true,
    conductive: false,
    ...
    {/*OXYG*/
    name: 'Oxygen Gas',
    desc: 'Uh idk im out of funny stuff',
    abbr: 'OXYG',
    color: '#80A0FF',
    flammable: true,
    conductive: false,
    ...
    defaultTemp: 72.0,
    highTemperatureChange: {temp:-1,type:-1},
    lowTemperatureChange: {temp:-297.3,type:53},
    explosiveChange: {strength:0,id:-1},
    isLiquid: false,
    isGas: true,
    isPowder: false,
    ...
    defaultTemp: -298,
    highTemperatureChange: {temp:-1,type:-1},
    lowTemperatureChange: {temp:-296,type:52},
    explosiveChange: {strength:0,id:-1},
    isLiquid: true,
    isGas: false,
    isPowder: false,
